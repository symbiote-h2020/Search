 ...
 */
public class ModelModifiedConsumer extends DefaultConsumer {

    private static Log log = LogFactory.getLog(ModelModifiedConsumer.class);
     ...
     */
    public ModelModifiedConsumer(Channel channel,
    ...
    public void handleDelivery(String consumerTag, Envelope envelope,
        ...
        try {
            ...
            this.handler.updateInformationModel(model);
            log.debug("Model updated: " + model.getUri());
