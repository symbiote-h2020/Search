 ...
 */
public class ModelCreatedConsumer extends DefaultConsumer {
     ...
     */
    public ModelCreatedConsumer(Channel channel, PlatformHandler handler) {
        super(channel);
    ...
    public void handleDelivery(String consumerTag, Envelope envelope,
        ...
        try {
            ...
            handler.registerInformationModel(registerRequest);

            log.debug("Model registered: " + registerRequest.getUri());
