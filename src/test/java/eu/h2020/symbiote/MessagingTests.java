...
//            when(mockHandler.search(anyString(),isA(CoreQueryRequest.class))).thenReturn(response);
//
//            ObjectMapper mapper = new ObjectMapper();
...
//            Thread.sleep(1000);
//            verify(mockHandler,times(1)).search(anyString(),isA(CoreQueryRequest.class));
//
//        } catch (IOException e) {
//            e.printStackTrace();
//            fail(e.getMessage());
