...
//        QueryResponse searchResponse = searchHandler.search("1",searchReq);
//
//        CoreQueryRequest otherResReq = new CoreQueryRequest();
//        otherResReq.setId("mobile1");
//        QueryResponse otherSearchResponse = searchHandler.search("2",otherResReq);
//
...
//
//        searchResponse = searchHandler.search("1",searchReq);
//
//        otherSearchResponse = searchHandler.search("2",otherResReq);
//
//        assertNotNull(searchResponse);
//        assertNotNull(searchResponse.getResources());
...
//        System.out.println("<<<<<<<<<<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>");
//
//        searchResponse = searchHandler.search("2",searchReq);
//        assertNotNull(searchResponse);
//        assertNotNull(searchResponse.getResources());
...
//        searchResponse = searchHandler.search("3",searchReq);
//        assertNotNull(searchResponse);
//        assertNotNull(searchResponse.getResources());
